...
immediately, then ask one worker to persist explicitly registered keys. Opening
a settings page does not submit a write. Each key retains its own acknowledged value and at
